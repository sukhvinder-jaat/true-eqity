...
const PreSeed = () => {
  return (
    <div
      className="max-w-[1377px] mx-auto  lg:px-[67px] bg-seed bg-no-repeat bg-cover bg-center lg:min-h-[854px] xl:mb-[50px] flex items-end relative"
      id="preSeed"
    >
      <div className=" lg:px-0 px-[23px] lg:pt-0 pt-[74px]">
        <p className=" max-w-[960px] lg:mb-[65px] mb-5 xl:text-3xl md:text-[70px] sm:text-[60px] text-[52px]  leading-[120%] text-white font-inter font-bold">
