...
export const HeroArrow = () => {
  return (
    <svg
      width="58"
      height="58"
      className=" cursor-pointer md:max-w-[58px] max-w-[36px] md:max-h-[58px] max-h-[36px] animate-bounce"
      viewBox="0 0 58 58"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
    >
...
export const SeedIcon = () => {
  return (
    <svg
      width="75"
      height="93"
      className="max-w-[61px] lg:max-w-[91px] lg:max-h-[63px] max-h-[74px]"
      viewBox="0 0 75 93"
      fill="none"
      xmlns="http://www.w3.org/2000/svg"
    >
      ...
      <rect
        ...
        width="91.7308"
        height="18.9147"
        transform="rotate(-90 27.8835 92.1616)"
        fill="white"
      />
      <rect
        x="55.969"
