    ...
    >
      <div className=" flex flex-wrap items-center lg:px-0 md:px-[32px]">
        <div className=" lg:w-6/12 w-full xl:pe-[64px] lg:pe-10 lg:mb-0 mb-[58px] lg:px-0 px-[32px]">
          <p className=" text-black font-inter font-bold xl:text-3xl md:text-[70px] sm:text-[60px] text-[52px]  leading-[120%] mb-[34px]">
      ...
      <div className="max-w-[883px] px-0 mx-auto flex lg:flex-col flex-col-reverse items-center lg:mt-[-70px] lg:mb-[205px]">
        ...
        <div className=" w-full lg:max-w-[620px] lg:px-0 px-[32px] lg:mt-[86px] md:mt-10 mt-[30px] lg:mb-0 mb-[59px]">
          <p className=" text-black font-inter font-bold xl:text-3xl md:text-[70px] sm:text-[60px] text-[52px]  leading-[120%] mb-[34px]">
